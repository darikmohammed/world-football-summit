...
const moreFeaturedSpeakers = document.querySelector(
  ".more-feature-speaker-mbl"
);
const lessFeaturedSpeakers = document.querySelector(
  ".less-feature-speaker-mbl"
);
...
dynamicSpeakers();
window.addEventListener("resize", dynamicSpeakers);

//More button click

moreFeaturedSpeakers.addEventListener("click", () => {
  document.querySelector(".featured-speakers .speakers-card").innerHTML = "";
  for (let i = 0; i < featuredSpeakers.length; i += 1) {
    document.querySelector(".featured-speakers .speakers-card").innerHTML += `
    <div class="card">
  ...
  moreFeaturedSpeakers.style.display = "none";
  lessFeaturedSpeakers.style.display = "block";
});

lessFeaturedSpeakers.addEventListener("click", () => {
  document.querySelector(".featured-speakers .speakers-card").innerHTML = "";
  for (let i = 0; i < 2; i += 1) {
    document.querySelector(".featured-speakers .speakers-card").innerHTML += `
    <div class="card">
  ...
  moreFeaturedSpeakers.style.display = "block";
  lessFeaturedSpeakers.style.display = "none";
});
